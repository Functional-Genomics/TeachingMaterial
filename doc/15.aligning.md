...
*Note*: As later some preprocessed data is used, the latest version of genome assembly and annotation (currently 82) is not used. Instead we are using the release 62 for consistency purposes.
...
tophat Drosophila_melanogaster.BDGP5.25.62.dna_rm.toplevel \
   SRR031714_1_filt3.fastq \
   SRR031714_2_filt3.fastq
```
