...
```bash
cat ERR315494_pe_1.fastq | prinseq-lite \
    -fastq stdin \
    -out_good ERR315494_pe_1_filt1 \
    -out_bad null \
    -trim_qual_right 30 -min_len 32 \
    -ns_max_p 5 \
    -lc_method dust -lc_threshold 10
    
cat ERR315494_pe_2.fastq | prinseq-lite \
    -fastq stdin \
    -out_good ERR315494_pe_2_filt1 \
    -out_bad null \
    -trim_qual_right 30 -min_len 32 \
    -ns_max_p 5 \
    -lc_method dust -lc_threshold 10
...
```bash
fastq-mcf adapters.fa ERR315414_1.fastq ERR315414_2.fastq \
...
```bash
cat ERR315414_1.fastq | prinseq-lite \
    -fastq stdin \
