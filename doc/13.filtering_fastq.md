...
cat SRR031714_2.fastq | prinseq-lite \
    ...
    -lc_method dust -lc_threshold 10
```
[output of the original files](https://github.com/Functional-Genomics/TeachingMaterial/blob/EMBLPredocCourse2015/output/_filtering_fastq_filt1.md)
...
[output of the original files](https://github.com/Functional-Genomics/TeachingMaterial/blob/EMBLPredocCourse2015/output/_filtering_fastq_filt2.md)
...
cat SRR031714_2.fastq | prinseq-lite \
    ...
    -trim_right 5
```
[output of the original files](https://github.com/Functional-Genomics/TeachingMaterial/blob/EMBLPredocCourse2015/output/_filtering_fastq_filt3.md)
